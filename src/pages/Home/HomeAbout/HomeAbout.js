...
const HomeAbout = () => {
  ...
  return (
    <Box
      sx={{
        bgcolor: "#f2f2f2",
        pt: { lg: "280px", sm: "390px", xs: "390px", md: "240px" },
        mt: { lg: "-266px", xs: "-431px", sm: "-431px", md: "-276px" },
      }}
    >
      <Container>
        <Grid container spacing={3}>
          ...
          >
            ...
            <Typography
              sx={{
                mt: { lg: "-45px", md: "-45px", sm: "-26px", xs: "-26px" },
                color: "#283d58",
                fontSize: { lg: "48px", md: "48px", sm: "30px", xs: "30px" },
                mb: "25px",
              }}
              variant="h3"
            >
          ...
          <Grid
            ...
            md={4}
            lg={4}
            sx={{ display: "flex", alignItems: "flex-end", mt: "20px" }}
          >
